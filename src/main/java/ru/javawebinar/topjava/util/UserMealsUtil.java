...
public class UserMealsUtil {
    private  static Map<Integer, UserMeal> userMeals=inintUserMeals();
    ...
    public static Map<Integer, UserMeal> inintUserMeals() {
        Map<Integer, UserMeal> mealMap = new HashMap<>();
        UserMeal userMeal = new UserMeal(LocalDateTime.of(2015, Month.MAY, 30, 10, 0), "Завтрак", 500);
        mealMap.put(userMeal.getId(), userMeal);
        userMeal = new UserMeal(LocalDateTime.of(2015, Month.MAY, 30, 13, 0), "Обед", 1000);
        mealMap.put(userMeal.getId(), userMeal);
        userMeal = new UserMeal(LocalDateTime.of(2015, Month.MAY, 30, 20, 0), "Ужин", 500);
        mealMap.put(userMeal.getId(), userMeal);
        userMeal = new UserMeal(LocalDateTime.of(2015, Month.MAY, 31, 10, 0), "Завтрак", 1000);
        mealMap.put(userMeal.getId(), userMeal);
        userMeal = new UserMeal(LocalDateTime.of(2015, Month.MAY, 31, 13, 0), "Обед", 500);
        mealMap.put(userMeal.getId(), userMeal);
        userMeal = new UserMeal(LocalDateTime.of(2015, Month.MAY, 31, 20, 0), "Ужин", 510);
        mealMap.put(userMeal.getId(), userMeal);
        return mealMap;
    }
    public static Map<Integer, UserMeal> getUserMeals(){
        return userMeals;
    }
